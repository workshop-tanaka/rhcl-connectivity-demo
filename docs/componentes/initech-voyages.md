...
| Plano | `silver` |
| Rajada | 10 req/10s |
| Cota diária | 10 000/dia |
| Chave | `apikey-silver-initech`, em `kuadrant-system` |

## O que define o plano dele

Uma coisa só: o label `kuadrant.io/plan-id: silver` no Secret da chave. É ele que
...
Há um usuário `initech-voyages` no Keycloak e no GitLab, com papel **Developer**: ele abre
