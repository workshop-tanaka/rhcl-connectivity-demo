...
| Plano | `gold` |
| Rajada | 30 req/10s |
| Cota diária | 100 000/dia |
| Chave | `apikey-gold-globex`, em `kuadrant-system` |

## O que define o plano dele

Uma coisa só: o label `kuadrant.io/plan-id: gold` no Secret da chave. É ele que
...
Há um usuário `globex-travel` no Keycloak e no GitLab, com papel **Developer**: ele abre
